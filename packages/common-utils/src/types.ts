...
export const TeamApiKeyMemberSchema = z.object({
  _id: z.string(),
  email: z.string(),
  name: z.string().optional(),
});
...
export const TeamApiKeySchema = z.object({
  ...
  key: z.string(),
  createdAt: z.string(),
  members: z.array(TeamApiKeyMemberSchema).optional(),
});

export type TeamApiKey = z.infer<typeof TeamApiKeySchema>;

export const TeamApiKeysApiResponseSchema = z.object({
  data: z.array(TeamApiKeySchema),
});

export type TeamApiKeysApiResponse = z.infer<
  typeof TeamApiKeysApiResponseSchema
>;

export const CreateTeamApiKeyApiResponseSchema = z.object({
  data: TeamApiKeySchema,
});

export type CreateTeamApiKeyApiResponse = z.infer<
  typeof CreateTeamApiKeyApiResponseSchema
>;
