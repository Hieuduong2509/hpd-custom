...
export function SourcesList({
  ...
  // Only admins may create/edit/delete Sources — dev/owner can view and
  // query the underlying data, but the write routes are blocked server-
  // side (requireRole('admin') in routers/api/sources.ts), so this hides
  // controls that would otherwise 403.
  ...
  return (
    <Wrapper {...wrapperProps}>
      <Stack gap="md">
        ...
        {isAdmin && !IS_LOCAL_MODE && !isCreatingSource && (
          <Flex
            justify="flex-end"
