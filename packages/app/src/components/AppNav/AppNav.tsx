        ...
        >
          ...
          {!isCollapsed && (
            ...
            >
              ...
              {/* Removed per request: ClickHouse Cloud upsell banner
                  ("Ready to deploy on ClickHouse Cloud? Get Started for
                  Free") — not relevant, this fork self-hosts ClickHouse. */}
            </div>
          )}
        </ScrollArea>
